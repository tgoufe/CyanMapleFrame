<template>
<div class="cmui-list overflow-xh">
	<div class="clearfix" :class="'marginr-n'+spaceName">
		<slot></slot>
	</div>
</div>
</template>
...
export default {
	...
	mounted(){
		...
		if(this.dragable){
			...
			!('draggable' in options) && (options.draggable =  '.cmui-list-item');
			this._sortable = new Sortable(this.rootContainer, options)
			this.computeIndexes()
		}
	},
	beforeDestroy() {
		this.dragable&&this._sortable.destroy()
	},
	watch: {
		options: {
